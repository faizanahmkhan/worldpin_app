...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Pin pin3 = new Pin("Swag description3", new Date(3 - 10 - 2020), "Paris", 55, user2);
        Pin pin4 = new Pin("Swag description4", new Date(4 - 10 - 2019), "Krakow", 44, user2);
        Pin pin5 = new Pin("Swag description5", new Date(5 - 10 - 2018), "Berlin", 33, user3);
        Pin pin6 = new Pin("Swag description6", new Date(6 - 10 - 2017), "Amsterdam", 22, user3);
        Pin pin7 = new Pin("Swag description7", new Date(7 - 10 - 2017), "Budapest", 11, user4);
        Pin pin8 = new Pin("Swag description8", new Date(8 - 10 - 2017), "Rome", 0, user4);
